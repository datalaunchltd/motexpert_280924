                ...
                <thead class="responsive-table__head" style="position: sticky; top: 0; z-index: 1;">
                    <tr class="responsive-table__row">
                     ...
                     <tr class="responsive-table__row data-launch-inactive" id='data-launch-testing-station-filter-container'>
                        ...
                        <th class="responsive-table__head__title responsive-table__head__title--status" scope="col">
                            <input type="text" class="data-launch-filter-search" data-launch-header="contactMainNo" style="width: 100%;" placeholder="" value="">
                        </th>
                        <th class="responsive-table__head__title responsive-table__head__title--status" scope="col">
    ...
    buildTableBody (data) {
        ...
        if (data.length === 0) {
            ...
            for (let i = 0; i < data.length; i++) {
                html += `
                <tr class="responsive-table__row export-row" data-export-row="${exportRow}" data-export-header="VTS Site No" data-export-val="${data[i].vts_site_number}" data-vts-pro-id="${data[i].id}">
                    <td class="responsive-table__body__text responsive-table__body__text--types export-record data-launch-testing-station-view-record-click" data-export-row="${exportRow}" data-export-header="VTS ID" data-export-val="${data[i].id}" scope="row">${data[i].id}</td>
                    <td class="responsive-table__body__text responsive-table__body__text--name export-record data-launch-testing-station-view-record-click" data-export-row="${exportRow}" data-export-header="Trading Name" data-export-val="${data[i].trading_name}" scope="row">
                    ...
                    <td class="responsive-table__body__text responsive-table__body__text--types export-record data-launch-testing-station-view-record-click" data-export-row="${exportRow}" data-export-header="Contact Main No"                data-export-val="${data[i].contactMainNo}" scope="row">${data[i].contactMainNo}</td>
                    ...
                    <td class="responsive-table__body__text responsive-table__body__text--types export-record data-launch-testing-station-view-record-click" data-export-row="${exportRow}" data-export-header="Date Called"                data-export-val="${data[i].dateCalled}" scope="row">${data[i].dateCalled}</td>
                    <td class="responsive-table__body__text responsive-table__body__text--types export-record data-launch-testing-station-view-record-click" data-export-row="${exportRow}" data-export-header="CPD Needed"                data-export-val="${data[i].cpdNeeded}" scope="row">${data[i].cpdNeeded}</td>
                    <td class="responsive-table__body__text responsive-table__body__text--types export-record data-launch-testing-station-view-record-click" data-export-row="${exportRow}" data-export-header="Consultant"                data-export-val="${data[i].consultant}" scope="row">${data[i].consultant}</td>
                </tr>` 
                exportRow++           
            }
        }      
